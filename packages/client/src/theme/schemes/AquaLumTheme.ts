...
const colors = {
  ...
  day: {
    lighter: lighten(themeColors.day, 0.85),
    light: lighten(themeColors.day, 0.3),
    main: themeColors.day,
    dark: darken(themeColors.day, 0.2)
  },
  moon: {
    lighter: lighten(themeColors.moon, 0.85),
    light: lighten(themeColors.moon, 0.3),
    main: themeColors.moon,
    dark: darken(themeColors.moon, 0.2)
  },
  night: {
    lighter: lighten(themeColors.night, 0.85),
    light: lighten(themeColors.night, 0.3),
    main: themeColors.night,
    dark: darken(themeColors.night, 0.2)
  },
};

export const AquaLumTheme = createTheme({
  // direction: i18n.dir(),
  colors: {
    gradients: {
    ...
    day: {
      lighter: alpha(themeColors.day, 0.1),
      light: lighten(themeColors.day, 0.3),
      main: themeColors.day,
      dark: darken(themeColors.day, 0.2)
    },
    moon: {
      lighter: alpha(themeColors.moon, 0.1),
      light: lighten(themeColors.moon, 0.3),
      main: themeColors.moon,
      dark: darken(themeColors.moon, 0.2)
    },
    night: {
      lighter: alpha(themeColors.night, 0.1),
      light: lighten(themeColors.night, 0.3),
      main: themeColors.night,
      dark: darken(themeColors.night, 0.2)
    },
